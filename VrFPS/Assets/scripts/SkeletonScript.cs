...
public class SkeletonScript : MonoBehaviour {
	//declare the transform of our goal (where the navmesh agent will move towards) and our navmesh agent (in this case our skeleton)
	...
	{
		//first disable the skeleton's collider so multiple collisions cannot occur
		...
		//if the zombie skeleton positioned less than or equal to 3 scene units away from the camera we won't be able to shoot it
